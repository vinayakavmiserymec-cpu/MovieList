...
apiRoute.get('/:movieId',function getMovies(req,resp) {
    console.log('get movies details  is called for ' + req.params.movieId)

    if(req.params.movieId) {
        const movie = moviesList.find(movie => movie._id=== req.params.movieId) 
        resp.json({movie})
...
apiRoute.get('/',function getMovies(req,resp) {
